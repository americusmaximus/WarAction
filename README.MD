...
Notes:
1. Re-engineered code contains additional conditional code using DirectDraw 7 interfaces to render the game. This is enabled on x64 compilation configuration.
